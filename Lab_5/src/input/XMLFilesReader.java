...
/**
 * The class which is intended to read XML data and put it into the collection.
 */
public class XMLFilesReader implements FilesReader {
     ...
     */
    public XMLFilesReader(OutputManager outputManager, CollectionManager collectionManager) {
        this.outputManager = outputManager;
        this.collectionManager = collectionManager;
    }

    /**
     * Reads XML data and puts it into the collection
    ...
    public void readFile(File file) throws FileNotFoundException {
        ...
        try {
            ...
            outputManager.printErrorMessage("Содержимое файла не в формате xml.");
        }
    }
}
